...
class ContestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post contests_url, params: { contest: { name: @contest.name, shortname: @contest.shortname } }, as: :json
    end
  ...
  test "should update contest" do
    patch contest_url(@contest), params: { contest: { name: @contest.name, shortname: @contest.shortname } }, as: :json
    assert_response 200
  end
